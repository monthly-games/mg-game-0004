...
import 'package:cafe_match_tycoon/main.dart' as app;

void main() {
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();

  testWidgets('Comprehensive Feature Test - MG-0004', (WidgetTester tester) async {
    // 1. App Launch
    app.main();
    ...
    debugPrint('Comprehensive E2E completed for MG-0004');
  });
}