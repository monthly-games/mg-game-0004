...
### 핵심 기능
- [x] 매치3 퍼즐 엔진 (8x8 그리드, 스왑/매치/중력/연쇄)
- [x] 특수 블록 시스템 (로켓H/V, 폭탄, 레인보우)
- [x] 카페 경영 시스템 (CafeManager - 재료, 업그레이드)
- [x] 메뉴 제작 (4가지: Espresso, Latte, Americano, Macchiato)
- [x] 손님 응대 (CustomerManager - 주문, 기분, 팁 시스템)
- [x] 방치 수익 (IdleIncomeManager - 오프라인 골드)
