# MG-0004: Cafe Match Tycoon

> **Genre:** Match-3/Tycoon  
> **Platform:** Android / iOS / Web  
> **Engine:** Flutter + Flame

## Overview

Match-3 puzzle combined with cafe management

<!-- MG-GAME-SHOWCASE:START -->
## Gameplay Showcase

![Cafe Match Tycoon gameplay screen](docs/images/gameplay-showcase.png)

**Cafe Match Tycoon** centers on the **Upgrade and Grow** loop. The player enters from the main menu, reads the active objective and pressure state, performs the core action, banks rewards, then returns through roadmap and retention goals.
...
git clone --recursive https://github.com/monthly-games/mg-game-0004.git
