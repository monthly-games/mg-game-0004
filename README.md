...
이 프로젝트는 **카페 매치 타이쿤**의 Flutter 구현체입니다.
...
| 문서 | 설명 |
|------|------|
| [docs/design/gdd_game_0004.json](docs/design/gdd_game_0004.json) | 게임 디자인 문서 |
...
**HUD 파일**: [game/lib/ui/hud/mg_puzzle_hud.dart](game/lib/ui/hud/mg_puzzle_hud.dart)

### 주요 HUD 요소

| 요소 | 설명 | 컴포넌트 |
|------|------|----------|
| **점수 (Score)** | 현재 점수 및 목표 점수 | Custom Container |
| **골드** | 카페 운영 골드 표시 | MGResourceBar |
| **이동 횟수 (Moves)** | 남은 이동 횟수 | MGResourceBar |
| **힌트 버튼** | 퍼즐 힌트 제공 | MGButton |
...
퍼즐 게임 HUD 예제는 가이드 문서의 "Puzzle Game" 섹션을 참고하세요.
